...
namespace employeeManagementSystem.employeeDBDataSet3TableAdapters {
...
SELECT id, firstName, LastName, dob, gender, salary, brachID, Email, PhoneNumber, Adress, desegnation FROM employee WHERE (id = @id)";
        ...
        public virtual int Fill(employeeDBDataSet3.employeeDataTable dataTable) {
        ...
        public virtual employeeDBDataSet3.employeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            employeeDBDataSet3.employeeDataTable dataTable = new employeeDBDataSet3.employeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(employeeDBDataSet3.employeeDataTable dataTable) {
