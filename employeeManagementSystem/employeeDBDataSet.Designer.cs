...
namespace employeeManagementSystem {
    ...
    public partial class employeeDBDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeeRow AddemployeeRow(string id, string firstName, string LastName, string dob, string gender, double salary, string brachID) {
...
namespace employeeManagementSystem.employeeDBDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[employee] ([id], [firstName], [LastName], [dob], [gender], [salary], [brachID]) VALUES (@id, @firstName, @LastName, @dob, @gender, @salary, @brachID);
SELECT id, firstName, LastName, dob, gender, salary, brachID FROM employee WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [id] = @id, [firstName] = @firstName, [LastName] = @LastName, [dob] = @dob, [gender] = @gender, [salary] = @salary, [brachID] = @brachID WHERE (([id] = @Original_id) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_dob = 1 AND [dob] IS NULL) OR ([dob] = @Original_dob)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)) AND ((@IsNull_brachID = 1 AND [brachID] IS NULL) OR ([brachID] = @Original_brachID)));
SELECT id, firstName, LastName, dob, gender, salary, brachID FROM employee WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, firstName, LastName, dob, gender, salary, brachID FROM dbo.employee";
        ...
        public virtual int Delete(string Original_id, string Original_firstName, string Original_LastName, string Original_dob, string Original_gender, global::System.Nullable<double> Original_salary, string Original_brachID) {
            if ((Original_id == null)) {
        ...
        public virtual int Insert(string id, string firstName, string LastName, string dob, string gender, global::System.Nullable<double> salary, string brachID) {
            if ((id == null)) {
        ...
        public virtual int Update(string id, string firstName, string LastName, string dob, string gender, global::System.Nullable<double> salary, string brachID, string Original_id, string Original_firstName, string Original_LastName, string Original_dob, string Original_gender, global::System.Nullable<double> Original_salary, string Original_brachID) {
            if ((id == null)) {
                throw new global::System.ArgumentNullException("id");
            }
            else {
            ...
            if ((Original_salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((double)(Original_salary.Value));
            }
            else {
            ...
            if ((Original_brachID == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[19].Value = ((string)(Original_brachID));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string LastName, string dob, string gender, global::System.Nullable<double> salary, string brachID, string Original_id, string Original_firstName, string Original_LastName, string Original_dob, string Original_gender, global::System.Nullable<double> Original_salary, string Original_brachID) {
            return this.Update(Original_id, firstName, LastName, dob, gender, salary, brachID, Original_id, Original_firstName, Original_LastName, Original_dob, Original_gender, Original_salary, Original_brachID);
        }
    }
